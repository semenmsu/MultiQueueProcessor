...
public:
    ...
    RandomSubscribeConsumersBag(ISubscriber<Key, Value> &dispatcher, size_t max_consumers, int32_t delay) : dispatcher_(dispatcher), max_consumers_(max_consumers), delay_(delay)
    {
